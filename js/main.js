...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const workData = {
        ...
        */
        ...
        '20': {
            title: 'EN-LIGHT個別指導塾',
            description: '杉並区の個別指導塾のWebサイト。中高生の学習をサポートし、一人ひとりの学習状況に合わせた完全個別指導で志望校合格を目指す教育サービス。',
            image: 'images/works/work20.webp',
            url: 'https://kasaman04.github.io/en-light-school/index.html',
            details: [
                '完全個別指導システム',
                'カスタマイズ学習プラン',
                '合格実績の可視化',
        ...
        '21': {
            title: 'NALUビューティーサロン',
            description: '表参道のプライベートビューティーサロン。フェイシャル、ボディ、ネイルの総合美容サービスを提供し、「素肌も心も、ふわりとほどける」をコンセプトにした癒しの空間。',
            image: 'images/works/work21.webp',
            url: 'https://kasaman04.github.io/nalu-salon/',
            details: [
                'プライベートサロン体験',
                'カスタマイズ美容トリートメント',
                'オンライン予約システム',
        ...
        '22': {
            title: '青山ラクステクリニック',
            description: '青山の美容皮膚科クリニック。女性医師による丁寧なカウンセリングと最新の医療技術で、レーザー脱毛や肌治療を提供する医療美容サービス。',
            image: 'images/works/work22.webp',
            url: 'https://kasaman04.github.io/aoyama-luxe-clinic/',
            details: [
                '女性医師による診療',
                'プライベート個室完備',
                '最新レーザー治療機器',
        ...
        '23': {
            title: '山井川事務所',
            description: '東京の行政書士・税理士事務所。起業支援から相続手続きまで、20年の経験と行政書士・税理士の両資格を活かしたワンストップサービスを提供。',
            image: 'images/works/work23.webp',
            url: 'https://kasaman04.github.io/yamaigawa-office/',
            details: [
                '行政書士・税理士ダブル資格',
                '起業から相続まで一貫サポート',
                '平日夜間・土日対応可能',
        ...
        '24': {
            title: 'RE:EDITサステナブルファッション',
            description: 'ヴィンテージ古着を独創的にリメイクするサステナブルファッションブランド。一点物のリメイクアイテムで環境に配慮した新しいファッションスタイルを提案。',
            image: 'images/works/work24.webp',
            url: 'https://kasaman04.github.io/re-edit-website/',
            details: [
                '一点物リメイクアイテム',
                'ヴィンテージ素材活用',
                'カスタムオーダー対応',
